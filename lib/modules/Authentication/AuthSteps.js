...
export var EnterPhoneNumberStep = function (_a) {
    var authStep = _a.authStep, theme = _a.theme, onSetFocusToPhoneInput = _a.onSetFocusToPhoneInput, onSignInWithAnotherMethods = _a.onSignInWithAnotherMethods, AUTH_STEPS = _a.AUTH_STEPS;
    return (React.createElement(AnimatedAuthStepContainer, { style: { height: authStep === AUTH_STEPS.ENTER_PHONE_NUMBER ? 'auto' : 0 }, pose: authStep === AUTH_STEPS.ENTER_PHONE_NUMBER ? 'visible' : 'hidden' },
        React.createElement(SignInWithPhone, { theme: theme, onSignInWithAnotherMethods: onSignInWithAnotherMethods, onInputFocus: function () { return onSetFocusToPhoneInput(true); } })));
};
