...
var SignIn = /** @class */ (function (_super) {
    ...
    SignIn.prototype.render = function () {
        ...
        var _b = this.props, theme = _b.theme, firebase = _b.firebase, onLoggedIn = _b.onLoggedIn;
        return (React.createElement(PaperProvider, { theme: __assign({}, DefaultTheme, { colors: __assign({}, DefaultTheme.colors, { primary: theme.colors.primary }), fonts: __assign({}, DefaultTheme.fonts) }) },
            React.createElement(ThemeProvider, { theme: theme },
                React.createElement(AuthContextProvider, { firebase: firebase, onLoggedIn: onLoggedIn },
                    React.createElement(ScrollView, { contentContainerStyle: { flex: 1 }, keyboardShouldPersistTaps: 'handled' },
                        ...
                        React.createElement(KeyboardAvoidingView, { style: { flex: 1 }, behavior: Platform.OS === 'ios' ? 'padding' : 'padding', enabled: true },
                            React.createElement(Styled.SignIn.GetStarted, null,
                                !openSignInWithAnotherMethods && (React.createElement(EnterPhoneNumberStep, { authStep: authStep, onSignInWithAnotherMethods: function () {
                                ...
                                focusToPhoneInput && (React.createElement(SubmitButton, { AUTH_STEPS: AUTH_STEPS, authStep: authStep, onNextAuthStep: this.onNextAuthStep })),
                                React.createElement(AnimatedSignInWithAnotherMethods, { pose: openSignInWithAnotherMethods ? 'visible' : 'hidden' }, openSignInWithAnotherMethods && React.createElement(SignInWithAnotherMethods, null))))),
