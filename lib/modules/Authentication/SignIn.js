...
var SignIn = /** @class */ (function (_super) {
    ...
    SignIn.prototype.render = function () {
        ...
        var _b = this.props, theme = _b.theme, firebase = _b.firebase, onLoggedIn = _b.onLoggedIn, signUpKeyboardOffset = _b.signUpKeyboardOffset;
                    ...
                    React.createElement(View, { style: { flex: 1 } },
                        ...
                        React.createElement(KeyboardAvoidingView, { style: { flex: 1 }, behavior: Platform.OS === 'ios' ? 'padding' : 'padding', enabled: true },
                            React.createElement(Styled.SignIn.GetStarted, null,
                                ...
                                React.createElement(AnimatedSignInWithAnotherMethods, { pose: openSignInWithAnotherMethods ? 'visible' : 'hidden' }, openSignInWithAnotherMethods && (React.createElement(SignInWithAnotherMethods, { signUpKeyboardOffset: signUpKeyboardOffset })))))),
