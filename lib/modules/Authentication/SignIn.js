                    ...
                    React.createElement(View, { style: { flex: 1 } },
                        ...
                        React.createElement(KeyboardAvoidingView, { style: { flex: 1 }, behavior: Platform.OS === 'ios' ? 'padding' : 'padding', enabled: Platform.OS === 'ios' },
                            React.createElement(Styled.SignIn.GetStarted, null,
                                ...
                                React.createElement(AnimatedSignInWithAnotherMethods, { pose: openSignInWithAnotherMethods ? 'visible' : 'hidden' }, openSignInWithAnotherMethods && (React.createElement(SignInWithAnotherMethods, { theme: theme, signUpKeyboardOffset: signUpKeyboardOffset })))))),
