...
var SignIn = /** @class */ (function (_super) {
    ...
    SignIn.prototype.render = function () {
        ...
        var _b = this.props, theme = _b.theme, firebase = _b.firebase, onLoggedIn = _b.onLoggedIn, signUpKeyboardOffset = _b.signUpKeyboardOffset, privacyUrl = _b.privacyUrl, statusBarHeight = _b.statusBarHeight;
