...
function updateUsername(token) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, fetch('https://asia-east2-ecobase-dev.cloudfunctions.net/api/username', {
                    method: 'POST',
                    headers: {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.props.firebase.auth().currentUser.getIdToken()];
                                    case 1:
                                        token = _a.sent();
                                        return [4 /*yield*/, updateUsername(token)];
                                    case 2:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
